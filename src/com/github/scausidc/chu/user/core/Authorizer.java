package com.github.scausidc.chu.user.core;
...
{
  // CONSTRUCT
    protected Integer SECRET_LENGTH;
    protected Integer SALT_LENGTH;
    ...
    public Authorizer()
    {
        ...
        this.SECRET_LENGTH = config.getInt("muuga.user.secretlength", 8);
        this.SALT_LENGTH = config.getInt("muuga.user.saltlength", 4);
